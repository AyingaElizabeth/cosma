...
class StaticPageSitemap(Sitemap):
    ...
    PAGES = [
        ...
        ("cosma_development:about_us",       0.9,  "monthly"),
        ("cosma_development:mission_vision", 0.8,  "monthly"),
        ("cosma_development:core_values",    0.8,  "monthly"),
        ("cosma_development:our_team",       0.7,  "monthly"),
        ("cosma_development:our_partners",   0.7,  "monthly"),
